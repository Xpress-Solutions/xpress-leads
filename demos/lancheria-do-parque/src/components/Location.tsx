  ...
  return (
    <section className="section location" id="localizacao">
      <div className="wrap reveal" ref={ref}>
        <p className="section-kicker">O 1086</p>
        <h2 className="section-title">Em frente à Redenção.</h2>
        ...
        <div className="loc-grid">
          <div className="loc-map">
            <iframe
              title="Mapa da Lancheria do Parque no Bom Fim"
              src={SITE.mapsEmbed}
              loading="lazy"
          ...
          <aside className="hours">
            ...
            <p className="menu-note">{HOURS_NOTE}</p>
