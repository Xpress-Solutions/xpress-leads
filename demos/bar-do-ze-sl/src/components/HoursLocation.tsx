...
export function HoursLocation() {
  ...
  return (
    <section className="section location" id="horario">
      <div className="wrap reveal" ref={ref}>
        <p className="section-kicker">Horário e a Roosevelt</p>
        <h2 className="section-title">Abre às 18h. Mesa na praça até a meia-noite.</h2>
        ...
        <div className="loc-grid">
          <div className="loc-map">
            <iframe
              title="Mapa do Bar do Zé na Roosevelt, São Leopoldo"
              src={SITE.mapsEmbed}
              loading="lazy"
