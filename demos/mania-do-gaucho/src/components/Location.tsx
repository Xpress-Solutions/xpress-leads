  ...
  return (
    <section className="section location" id="localizacao">
      <div className="wrap reveal" ref={ref}>
        ...
        <h2 className="section-title">Rua Felizardo, 465.</h2>
        ...
        <div className="loc-grid">
          <div className="loc-map">
            <iframe
              title="Mapa da Mania do Gaúcho II no Jardim Botânico"
              src={SITE.mapsEmbed}
              loading="lazy"
          ...
          <aside className="hours">
            ...
            <p className="hours-note">
              Tele-entrega no letreiro: {SITE.phonesShop[0].display} · {SITE.phonesShop[1].display}
            </p>
