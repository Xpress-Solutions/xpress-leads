  ...
  return (
    <section className="section" id="localizacao">
      <div className="wrap reveal" ref={ref}>
        ...
        <h2 className="title">Farroupilha, 3833.</h2>
        <p className="lead">
          {SITE.address.street}
          <br />
          {SITE.address.place}
        ...
        <div className="local-grid">
          <div className="map">
            <iframe
              title="Mapa do Masah! Sports Bar em Canoas"
              src={SITE.mapsEmbed}
              loading="lazy"
          ...
          <aside className="hours">
            ...
            <p className="lead" style={{ fontSize: "0.85rem", marginBottom: 14 }}>
              Horário da ficha do lead / Comida di Buteco. Algumas listagens antigas mostram sábado
              mais cedo — confirma no Zap.
            </p>
