...
export function Location() {
  ...
  return (
    <section className="section location" id="chegar">
      <div className="wrap reveal" ref={ref}>
        <p className="section-kicker">Como chegar</p>
        <h2 className="section-title">Felizardo, 336.</h2>
        ...
        <div className="loc-grid">
          <div className="loc-map">
            <iframe
              title="Mapa de O Barbeiro na Rua Felizardo, 336"
              src={SITE.mapsEmbed}
              loading="lazy"
          ...
          <aside className="hours">
            ...
            <div className="loc-actions">
              ...
              <a className="btn btn-ghost" href="#oficio">
                Ver o ofício
              </a>
            </div>
          </aside>
