  ...
  return (
    <section className="section" id="localizacao">
      <div className="wrap reveal" ref={ref}>
        <p className="section-kicker">Onde fica</p>
        <h2 className="section-title">Barão do Amazonas, 1240.</h2>
        <p className="section-lead">
          {SITE.address.street}
          <br />
          {SITE.address.neighborhood} · {SITE.address.city} — {SITE.address.state}
          <br />
          CEP {SITE.address.cep} · {SITE.address.nearby}
        </p>
        <div className="loc-grid">
          <div className="loc-map">
            <iframe
              title="Mapa do Barão 1240 no Jardim Botânico"
              src={SITE.mapsEmbed}
              loading="lazy"
